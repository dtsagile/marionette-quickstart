...
- (CGRect) invertFrameIfNeeded:(CGRect)rect orientation:(UIInterfaceOrientation)orientation {
    ...
    if (UIInterfaceOrientationIsLandscape(orientation) && (rect.size.width < rect.size.height) ) {
...
- (void) setStatusBarOverlaysWebView:(BOOL)statusBarOverlaysWebView
{
    ...
    if (statusBarOverlaysWebView) {
        ...
        if (UIInterfaceOrientationIsLandscape(self.viewController.interfaceOrientation)) {
